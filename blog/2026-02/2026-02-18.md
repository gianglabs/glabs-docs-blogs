...
> **📁 Repository**: All code from this tutorial is organized in the [variant-calling-gatk-pipeline-best-practice-from-scratch](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch) repository. The structure follows best practices with separate directories for bash (`workflows/bash/`) and Nextflow (`workflows/nextflow/`) implementations.
...
From Part 1, we have a complete 16-step GATK pipeline in bash ([`workflows/bash/gatk_pipeline.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/bash/gatk_pipeline.sh)). Here's Step 1 (FastQC quality control):
...
**Key details:**
- **Full pipeline location**: [`workflows/bash/gatk_pipeline.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/bash/gatk_pipeline.sh) (lines 70-74)
...
Create a clean Nextflow project (already available in [`workflows/nextflow/`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/tree/main/workflows/nextflow)):
...
> **💡 Tip**: Explore the complete repository structure in the [GitHub repo](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch). Each module corresponds to one GATK step, and you can view the source code directly.
...
Create `modules/fastqc.nf` ([view source](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/fastqc.nf)):
...
Create `main.nf` ([view source](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/main.nf)):
...
Create `nextflow.config` ([view source](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/nextflow.config)):
...
Create `validate_migration_step1.sh` (available in [`scripts/validate_migration.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/scripts/validate_migration.sh)):
...
All code from this blog is available at: [variant-calling-gatk-pipeline-best-practice-from-scratch](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch)

**Key Files:**
- **Bash Pipeline**: [`workflows/bash/gatk_pipeline.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/bash/gatk_pipeline.sh) - Complete 16-step bash workflow
- **Nextflow Main**: [`workflows/nextflow/main.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/main.nf) - Main workflow orchestration
- **Nextflow Config**: [`workflows/nextflow/nextflow.config`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/nextflow.config) - Configuration and profiles
- **Validation Script**: [`scripts/validate_migration.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/scripts/validate_migration.sh) - MD5 comparison tool
- **Data Download**: [`scripts/download_data.sh`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/scripts/download_data.sh) - Test data setup
- **Work Directory Guide**: [`workflows/nextflow/WORK_DIRECTORY_EXPLAINED.md`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/WORK_DIRECTORY_EXPLAINED.md) - Deep dive into Nextflow internals

**Nextflow Modules (18 DSL2 Processes):**
1. [`modules/fastqc.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/fastqc.nf) - Step 1: Quality control
2. [`modules/trim_galore.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/trim_galore.nf) - Step 2: Adapter trimming
3. [`modules/bwa_mem.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/bwa_mem.nf) - Step 3: Read alignment
4. [`modules/samtools_sort.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/samtools_sort.nf) - Step 4: BAM sorting
5. [`modules/gatk_markduplicates.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_markduplicates.nf) - Step 5: Mark PCR duplicates
6. [`modules/gatk_baserecalibrator.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_baserecalibrator.nf) - Step 6: BQSR table generation
7. [`modules/gatk_applybqsr.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_applybqsr.nf) - Step 7: Apply BQSR
8. [`modules/gatk_collectmetrics.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_collectmetrics.nf) - Step 8: Alignment QC (uses Broad Institute container with R)
9. [`modules/gatk_haplotypecaller.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_haplotypecaller.nf) - Step 9: Variant calling (GVCF)
10. [`modules/gatk_genotypegvcfs.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_genotypegvcfs.nf) - Step 10: Joint genotyping
11. [`modules/gatk_selectvariants_snp.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_selectvariants_snp.nf) - Step 11a: Extract SNPs
12. [`modules/gatk_variantfiltration_snp.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_variantfiltration_snp.nf) - Step 11b: Filter SNPs
13. [`modules/gatk_selectvariants_indel.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_selectvariants_indel.nf) - Step 12a: Extract indels
14. [`modules/gatk_variantfiltration_indel.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_variantfiltration_indel.nf) - Step 12b: Filter indels
15. [`modules/gatk_mergevcfs.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/gatk_mergevcfs.nf) - Step 13: Merge filtered VCFs
16. [`modules/snpeff.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/snpeff.nf) - Step 14: Functional annotation
17. [`modules/bcftools_stats.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/bcftools_stats.nf) - Step 15: Variant statistics
18. [`modules/bcftools_query.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/bcftools_query.nf) + [`modules/bedtools_genomecov.nf`](https://github.com/nttg8100/variant-calling-gatk-pipeline-best-practice-from-scratch/blob/main/workflows/nextflow/modules/bedtools_genomecov.nf) - Step 16: Visualization files
